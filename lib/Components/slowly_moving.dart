...
class SlowlyMovingWidgetsField extends StatefulWidget {
  ...
  final BoxDecoration bd;

  SlowlyMovingWidgetsField({@required this.list, this.collisionAmount, this.bd})
      : assert(list != null);

  @override
  _SlowlyMovingWidgetsFieldState createState() =>
      _SlowlyMovingWidgetsFieldState(bd);
}
...
class _SlowlyMovingWidgetsFieldState extends State<SlowlyMovingWidgetsField> {
  ...
  _SlowlyMovingWidgetsFieldState(BoxDecoration bd);
